...
def format_password_report(
    results: dict, as_json: bool = False, as_csv: bool = False
) -> str:
    """
...
def build_parser() -> argparse.ArgumentParser:
    ...
    cipher_parser.add_argument(
        ...
        type=int,
        required=True,
        help="The number of times to shift the letters",
    )
    cipher_parser.add_argument(
        "--decode", action="store_true", help="If present decode the text"
    )
    ...
    checkpw_parser.add_argument(
        "password", type=str, help="The password string to check"
    )
    checkpw_parser.add_argument(
        "--json", action="store_true", help="Output a json file"
    )
